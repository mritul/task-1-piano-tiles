...
if (localStorage.getItem("dataArrayHacker") == null) {
  const arrayForLocalStorage = [];
  localStorage.setItem("dataArrayHacker", JSON.stringify(arrayForLocalStorage));
}
        ...
        box.addEventListener("click", (e) => {
          ...
          if (
            ...
            var arrayFromLocalStorage = JSON.parse(
              window.localStorage.getItem("dataArrayHacker")
            );
